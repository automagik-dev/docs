...
<Tip>
The most common setup is one instance-level default route plus a few per-user overrides for VIP contacts. Start simple — you can always add per-chat routes later as patterns emerge.
</Tip>
