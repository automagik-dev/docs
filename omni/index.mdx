...
<CardGroup cols={2}>
  ...
  <Card title="Event-Driven Automations" icon="bolt" href="/omni/cli/automations">
  ...
  <Card title="Contact Directory" icon="address-book" href="/omni/cli/routes-persons-auth">
