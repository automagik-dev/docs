---
title: "Automations"
description: "Create event-driven workflows — trigger actions on messages, events, and custom conditions."
---
...
<Tip>
Create automations with `--disabled` first, then use `omni automations test` to verify conditions match expected events before enabling with `omni automations enable`.
</Tip>
