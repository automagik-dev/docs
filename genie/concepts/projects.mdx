...
Projects are created explicitly or auto-detected from repository paths:
...
- [Project CLI commands](/genie/cli/projects) — create, list, and manage projects from the command line
