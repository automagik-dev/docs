...
- **Worker registry** — all agents tracked in `~/.genie/workers.json`
...
**Trade-off:** Mixed providers mean mixed capabilities — Codex workers won't have Claude's native team integration features like session resume.
