...
title: "Agents"
sidebarTitle: "Agents"
description: "Autonomous workers with identities, roles, and lifecycle management."
---
...
Each spawn creates a tmux pane and registers the agent in the global worker registry (`~/.genie/workers.json`).
...
All spawned agents are tracked globally:

```
~/.genie/workers.json
```

This registry maps agent names to their tmux sessions, PIDs, teams, and status. The `genie ls` command reads this file.
