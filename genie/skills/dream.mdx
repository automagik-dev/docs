...
sidebarTitle: "/dream"
icon: "moon"
description: "Batch-execute SHIP-ready wishes overnight — pick wishes, orchestrate agents, review PRs, wake up to results."
---
...
4. **Phase 1 — Execute:** dispatch agents per wish via `genie work`.
...
- Dispatch agents via `genie work <agent> <slug>#<group>`
- Monitor via `genie status <slug>`
- Agents signal completion via `genie send`
