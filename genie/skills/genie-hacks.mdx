...
|----------|-------------|
| **planning** | Task vs wish, acceptance criteria, linting a plan |
| **parallel** | Wave shape, worktrees, the shared per-repo database |
| **skills** | Custom skills, saved workflows, microagents |
| **ops** | Doctor, budgets, install hygiene, release verification |
| **cost** | Token optimization, budget management |
| **integration** | External tools, Slack, CI/CD |
| **debugging** | Root-cause investigation, fix loops |
