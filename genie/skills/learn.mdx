...
<Warning>
  **This skill is retired and no longer ships.** The page is kept as history. See
  [The Genie Loop](/genie/skills/loop-overview) for the skills the current release delivers.
</Warning>
