...
<Steps>
  ...
  <Step title="Your first wish">
    ...
    The wizard routes you through [`/brainstorm`](/genie/skills/brainstorm) (if the idea needs sharpening) and then [`/wish`](/genie/skills/wish). One decided task comes back as a merge-ready PR; work that is bigger than one task becomes a `WISH.md` instead — scope, acceptance criteria, execution groups.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Agent went silent" icon="radio" href="/genie/cli/infrastructure">
