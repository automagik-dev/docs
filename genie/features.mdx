...
<CardGroup cols={2}>
  ...
  <Card title="14 Skills + /pm" icon="wand-magic-sparkles" href="/genie/concepts/skills">
...
**Learn more** — [Core Concepts](/genie/concepts/wishes) · [CLI Reference](/genie/cli/session) · [Architecture](/genie/architecture/overview) · [Installation](/genie/installation) · [Setup](/genie/config/setup)
