...
sidebarTitle: "State"
description: "Wish state machine, agent registry, teams, mailbox, team chat, boards, and projects"
---
...
Genie tracks state primarily in PostgreSQL via the embedded [pgserve database](/genie/config/files). Wishes, tasks, boards, projects, agents, teams, mailboxes, and team chat all live in PG tables. Legacy JSON file state has been replaced by database-backed equivalents.
