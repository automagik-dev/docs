...
├─────────────┬──────────────┬────────────────────────────┤
│  Skills     │  Commands    │  State                     │
│  brainstorm │  team create │  .genie/genie.db (SQLite)  │
│  wish       │  spawn       │  .genie/wishes/ (git)      │
│  work       │  send        │  ~/.genie/ (global)        │
│  review     │  status      │                            │
└──────┬──────┴──────┬───────┴──────────┬─────────────────┘
       │             │                  │
       ▼             ▼                  ▼
...
<Steps>
  ...
  <Step title="Execute">
    Agents work autonomously in their own worktrees, reading and writing wish and task state through the CLI.
  </Step>
  <Step title="Converge">
...
| `GENIE_AGENT_NAME` | Agent identity used by the CLI (must be set for auto-spawn) |
